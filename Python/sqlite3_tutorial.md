...
<br>
If'd we are interested to calulate the hours between two <code>DATETIME()</code> timestamps, we can could use the handy <code>SRFTIME()</code> function like this <br><br>
